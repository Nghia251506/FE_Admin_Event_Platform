      ...
      <div className="h-full flex items-center justify-between px-6">
        ...
        <div className="flex items-center gap-4">
          <div className="hidden md:block">
            <h2 className="text-sm font-bold text-white">Xin chào, {currentUser?.tenantName || 'Đội Lân Của Bạn'}! 👋</h2>
            <p className="text-xs text-dark-500">Sẵn sàng cho ngày mới</p>
          </div>
        </div>
        ...
        <div className="flex-1 max-w-xl mx-6">
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Tìm kiếm lịch diễn, khách hàng..."
        ...
        <div className="flex items-center gap-3">
          ...
          {/* Quick Menu */}
          <button className="p-2 hover:bg-dark-800 rounded-lg transition-colors md:hidden">
          ...
          <div className="flex items-center gap-3 pl-3 border-l border-dark-800">
            <div className="text-right hidden sm:block">
              <p className="text-sm font-medium text-dark-200">{currentUser?.fullName || 'Người dùng'}</p>
              <p className="text-xs text-dark-500">{currentUser?.roleName || 'Thành viên'}</p>
            </div>
            <div className="relative group">
              <button className="w-10 h-10 bg-gradient-to-br from-primary-600 to-accent-600 rounded-lg flex items-center justify-center hover:shadow-lg transition-all">
